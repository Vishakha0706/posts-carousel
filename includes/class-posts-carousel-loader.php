...
class Posts_Carousel_Loader {
	...
	public function add_shortcode( $hook, $component, $callback ) {
		$this->shortcodes = $this->pc_custom_add_shortcode( $this->shortcodes, $hook, $component, $callback );
	}
	 ...
	 */
	private function pc_custom_add_shortcode( $hooks, $hook, $component, $callback ) {
		$hooks[] = array(
			'hook'      => $hook,
			'component' => $component,
			'callback'  => $callback,
